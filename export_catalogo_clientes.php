<?php
// export_catalogo_clientes_callcenter.php - Export CSV del catalogo de clientes (Call Center)
// Incluye metricas por tipo, ultima compra, y candidatos a recompra (faltan <= 14 dias para vencer el plazo de la ultima venta de equipo)
//
// Uso:
//   export_catalogo_clientes_callcenter.php?q=&id_sucursal=0&solo_activos=1&solo_dormidos=0&solo_recompra=1&ultima_desde=2026-01-01&ultima_hasta=2026-02-25
//
// Notas:
// - Respeta visibilidad por rol (Luga/Subdis) igual que catalogo_clientes.php
// - CSV con BOM UTF-8 para Excel (incl. movil)
...
/* =========================
   Salida CSV
========================= */
$filename = "catalogo_clientes_callcenter_" . date('Ymd_His') . ".csv";
...
print(implode(',', array_map('csv_cell', $headers)) . "\n");
...
while ($row = $res->fetch_assoc()) {
    ...
    // Filtros PHP: rango ultima compra y dormidos/recompra
    ...
    // Segmento simple para callcenter
    ...
    print(implode(',', array_map('csv_cell', $line)) . "\n");
}
