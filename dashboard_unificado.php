...
/* ==============================
   ...
   🔹 Suma ventas de todos (activos e inactivos)
================================= */
$sqlSucursales = "
...
while ($row = $resSucursales->fetch_assoc()) {
    ...
    $cumplimiento = $row['cuota_semanal']>0 ? ($row['total_ventas']/$row['cuota_semanal']*100) : 0;
...
foreach ($sucursales as $s) {
    ...
    $zonas[$zona]['ventas'] += $s['total_ventas'];
    $zonas[$zona]['cuota'] += $s['cuota_semanal'];
}
