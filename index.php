...
<script>
  ...
  // Transición de salida + overlay (evita doble submit)
  (function(){
    ...
    form.addEventListener('submit', function(){
      ...
      // no prevenimos el submit; dejamos que el servidor responda y redirija
    });
  })();
</script>
</body>
