...
try {
  ...
  if (!$isAdmin) {
    $where[] = "(
      t.id_creador = ?
      OR t.id_responsable = ?
      OR EXISTS (SELECT 1 FROM tablero_watchers w WHERE w.id_tarea = t.id AND w.id_usuario = ?)
  ...
  $sql = "
    SELECT
      t.id, t.titulo, t.descripcion, t.estatus, t.prioridad,
      ...
      t.depende_de, t.visibilidad,
      t.id_creador, t.id_responsable,
