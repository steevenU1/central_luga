...
/* =========================================================
   ...
   Admin/Auditor/Logistica/GerenteZona pueden ver todo.
   Gerente/Supervisor solo su sucursal.
========================================================= */
...
$stmtUnit = $conn->prepare("
    SELECT
        ...
        SUM(CASE WHEN escaneado = 0 THEN 1 ELSE 0 END) AS total_pendientes
    FROM auditorias_snapshot
    WHERE id_auditoria = ?
");
$stmtUnit->bind_param("i", $id_auditoria);
$stmtUnit->execute();
$kpiUnit = $stmtUnit->get_result()->fetch_assoc() ?: [
    'total_esperados' => 0,
    'total_encontrados' => 0,
    'total_pendientes' => 0,
];
...
<div class="wrap">
        ...
        <div class="card">
            ...
            <div class="grid">
                ...
                <div class="kpi">
                    ...
                    <div class="kpi-value"><?= (int)$kpiUnit['total_encontrados'] ?></div>
                </div>
                <div class="kpi">
                    <div class="kpi-label">Pendientes</div>
                    <div class="kpi-value"><?= (int)$kpiUnit['total_pendientes'] ?></div>
                </div>
                <div class="kpi">
            ...
            <div class="notice">
                La parte de escaneo unitario la metemos en el siguiente bloque. Aquí ya te dejamos el resumen listo para conectar el escáner.
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="grid">
                ...
                <div class="kpi">
                    ...
                    <div class="kpi-value"><?= (int)$kpiCant['total_contadas'] ?></div>
                </div>
                <div class="kpi">
    ...
    <div class="card">
        <h2 class="section-title">Conteo de productos por cantidad</h2>
                    ...
                    <?php if (!$listaCantidades): ?>
                        <tr>
                            <td colspan="13" style="text-align:center; padding:24px;">
                                No hay productos por cantidad en esta auditoría.
                            </td>
                        </tr>
                    <?php else: ?>
