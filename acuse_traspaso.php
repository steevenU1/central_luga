...
<head>
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    header{
      display:flex; align-items:center; justify-content:space-between; gap:16px; padding-bottom:14px; border-bottom:2px solid var(--ink);
    }
    .brand{
      display:flex; align-items:center; gap:12px;
    }
    .brand .logo{
      width:56px; height:56px; border:2px solid var(--ink); border-radius:12px; display:grid; place-items:center; font-weight:800; letter-spacing:.5px;
    }
    ...
    table{
      width:100%; border-collapse:collapse; margin-top:18px; border:1px solid var(--line);
    }
    thead th{
      text-transform:uppercase; letter-spacing:.4px; font-size:11px; background:#f8fafc; border-bottom:1px solid var(--line);
    }
    ...
    .sign{
      border-top:1px dashed var(--line); padding-top:10px; min-height:84px;
    }
    ...
    .note{
      margin-top:10px; color:#7c3aed; background:#faf5ff; border:1px solid #e9d5ff; padding:8px 10px; border-radius:8px;
    }
    ...
    .toolbar .btn{
      border:1px solid var(--line); background:#fff; padding:6px 10px; border-radius:8px; cursor:pointer;
    }
  ...
  <table>
    ...
    <tbody>
      <?php if (!empty($items)): ?>
        ...
        <?php endforeach; ?>
      <?php else: ?>
        <tr><td colspan="6" style="text-align:center;color:#64748b;padding:18px 8px">Sin elementos para mostrar en este acuse.</td></tr>
      <?php endif; ?>
    </tbody>
  </table>
