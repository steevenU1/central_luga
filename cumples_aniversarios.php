...
<body>
        ...
        <div class="cele-body">
          <div id="captureArea" class="capture-area p-0">
            <div class="p-3 p-md-4">
              <div class="cele-wrap">
                <img id="mFoto" class="cele-photo" src="" alt="foto grande">
  ...
  <script>
    (function() {
      ...
      // Descargar PNG del contenido del modal
      $('btnDownload').addEventListener('click', async function() {
        const target = document.getElementById('captureArea');
        if (!target) return;

        // Ocultamos un poquito el “ruido” si quisieras, pero aquí lo dejamos tal cual.
      ...
      // Imprimir (abre ventana limpia con el contenido capturable)
  ...
  `;
          ...
          w.document.write(
            ...
            `<body><div class="box">${target.outerHTML}</div>${printScript}</body></html>`
          );
          w.document.close();
        });
        w.document.close();
